namespace WTCPortal.Models
{
    ...
    public partial class AdventureWorks : DbContext
    {
        ...
        public virtual DbSet<vEmployeeHistory> vEmployeeHistories { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Department>()
                .HasOptional(e => e.EmployeeDepartmentHistory)
            ...
            //modelBuilder.Entity<Employee>()
            //    .HasOptional(e => e.EmployeePayHistory)
            //    .WithRequired(e => e.Employee)
            //    .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<Person>()
               .HasOptional(e => e.EmailAddress)
               .WithRequired(e => e.Person)
               .WillCascadeOnDelete(false);

            modelBuilder.Entity<Person>()
                .HasOptional(e => e.PersonPhone)
                .WithRequired(e => e.Person)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<vEmployeeHistory>()
                .Property(e => e.Gender)
                .IsFixedLength();
        ...
        public System.Data.Entity.DbSet<WTCPortal.Models.StoreDemographics> StoreDemographics { get; set; }
    }
}
